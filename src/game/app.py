...
def appStarted(app):
    ...
    app.gameOver = False
    app.backButton = button(
        (5, 5, 30, 30), "#FF0000", "white", ("Comic Sans MS", 30, "bold italic")
    )
    settingsInit(app)
    app.mouseX = 0
    app.mouseY = 0
